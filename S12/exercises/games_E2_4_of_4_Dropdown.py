...
app.layout = html.Div(
    children=[
        ...
        # seleccionando el género
        html.Label('Genres:'),
        dcc.Dropdown(options=[{'label': x, 'value': x} for x in games_grouped['genre'].unique()], value=games_grouped['genre'].unique().tolist(), multi=True, id='genre_selector'),
...
def update_figures(start_date, end_date, mode, selected_genres):
    ...
    # crear gráficos según el modo seleccionado
